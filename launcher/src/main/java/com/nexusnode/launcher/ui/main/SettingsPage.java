...
import com.nexusnode.launcher.setting.*;
...
import com.nexusnode.launcher.upgrade.RemoteVersion;
import com.nexusnode.launcher.upgrade.UpdateChannel;
import com.nexusnode.launcher.upgrade.UpdateChecker;
import com.nexusnode.launcher.upgrade.UpdateHandler;
import com.nexusnode.launcher.util.Logging;
import com.nexusnode.launcher.util.i18n.Locales;
import com.nexusnode.launcher.util.io.FileUtils;
import com.nexusnode.launcher.util.javafx.SafeStringConverter;
...
import static com.nexusnode.launcher.util.javafx.ExtendedProperties.reversedSelectedPropertyFor;
import static com.nexusnode.launcher.util.javafx.ExtendedProperties.selectedItemPropertyFor;
...
public final class SettingsPage extends SettingsView implements DecoratorPage {
    ...
    protected void onSponsor() {
        FXUtils.openLink("https://hmcl.bluebird6900.net/api/redirect/sponsor");
    }
