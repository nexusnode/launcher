...
import com.nexusnode.launcher.event.EventManager;
import com.nexusnode.launcher.util.InvocationDispatcher;
import com.nexusnode.launcher.util.Lang;
import com.nexusnode.launcher.util.Logging;
import com.nexusnode.launcher.util.ReflectionHelper;
import com.nexusnode.launcher.util.function.ExceptionalConsumer;
import com.nexusnode.launcher.util.function.ExceptionalFunction;
import com.nexusnode.launcher.util.function.ExceptionalRunnable;
import com.nexusnode.launcher.util.function.ExceptionalSupplier;
...
public abstract class Task<T> {
    ...
    private static String getCaller() {
        return ReflectionHelper.getCaller(packageName -> !"com.nexusnode.launcher.task".equals(packageName)).toString();
    }
