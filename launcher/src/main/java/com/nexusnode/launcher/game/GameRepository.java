 ...
 * see {@link com.nexusnode.launcher.download.DependencyManager}
 *
 * @author bluebird6900
 */
public interface GameRepository extends VersionProvider {
     ...
     * Or if it returns a temporary directory, {@link com.nexusnode.launcher.launch.Launcher#makeLaunchScript} will fail.
     * If you do want to return a temporary directory, make {@link com.nexusnode.launcher.launch.Launcher#makeLaunchScript}
