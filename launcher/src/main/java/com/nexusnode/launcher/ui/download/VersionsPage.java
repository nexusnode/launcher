...
import com.nexusnode.launcher.download.game.GameRemoteVersion;
...
import com.nexusnode.launcher.ui.construct.FloatListCell;
import com.nexusnode.launcher.ui.construct.TwoLineListItem;
import com.nexusnode.launcher.ui.wizard.Refreshable;
import com.nexusnode.launcher.ui.wizard.WizardController;
import com.nexusnode.launcher.ui.wizard.WizardPage;
...
import static com.nexusnode.launcher.ui.FXUtils.stringConverter;
...
public final class VersionsPage extends BorderPane implements WizardPage, Refreshable {
    ...
    private void onSponsor() {
        FXUtils.openLink("https://hmcl.bluebird6900.net/api/redirect/bmclapi_sponsor");
    }
}
