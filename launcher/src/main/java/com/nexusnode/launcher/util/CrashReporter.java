...
import com.nexusnode.launcher.ui.CrashWindow;
import com.nexusnode.launcher.upgrade.IntegrityChecker;
...
public class CrashReporter implements Thread.UncaughtExceptionHandler {
    ...
    private static final Map<String, String> SOURCE = new HashMap<String, String>() {
        {
            ...
            put("com.nexusnode.launcher.util.ResourceNotFoundError", i18n("crash.NoClassDefFound"));
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        try {
            ...
            String text = "---- Crafting Dead Crash Report ----\n" +
    ...
    private void reportToServer(final String text) {
        Thread t = new Thread(() -> {
            ...
            try {
                String response = NetworkUtils.doPost(NetworkUtils.toURL("https://hmcl.bluebird6900.net/hmcl/crash.php"), map);
